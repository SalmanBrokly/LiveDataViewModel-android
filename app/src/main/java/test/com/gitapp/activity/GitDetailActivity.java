...
//            GetDetailModel categoryModel = ViewModelProviders.of(this).get(GetDetailModel.class);
            GetDetailModel categoryModel = ViewModelProviders.of(this, new GetDetailViewModelFactory(GitDetailActivity.this.getApplication(), getIntent().getStringExtra("DETAIL_URL"))).get(GetDetailModel.class);
